...
const Navbar = () => {
  return (
    <div className='flex justify-between h-14 px-60 py-3.5 bg-linear-to-r from-indigo-400 to-cyan-400 text-white font-bold text-2xl'>
      ...
      <a href="https://github.com/"><div className="flex justify-between gap-2.5 items-center" ><span>GitHub</span><span><img className="h-7 w-7" src={github} alt="github_logo" /></span></div></a>
    </div>
  )
}
